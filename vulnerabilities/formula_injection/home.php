<div class="thumbnail">
    ...
    <div class="caption-full">
        ...
        <p align="justify">
            CSV Formula injection is also known as CSV Excel Macro Injection. This happens when the application does not validate the content of CSV file. Applications that allow exporting/downloading data in CSV or excel format are usually vulnerable to such attacks.
        </p>
        <p>Read more about CSV Formula Injection <br>
        ...
        <p>
            Hint: Find a way to create or update an item with your payload
        </p>
