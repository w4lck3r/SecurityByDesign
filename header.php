<link rel="icon" type="image/png" href="<?php echo $XVWA_WEBROOT; ?>/xvwa/img/xvwa-logo-1.png" />
<div class="container">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?php echo $XVWA_WEBROOT; ?>/xvwa/">XVWA</a>
    </div>
            ...
            <li class="dropdown" id="menuLogin">
                <?php
                    ...
                    if(isset($_SESSION['user'])){
                        // Échapper les données dynamiques pour éviter les attaques XSS
                        $username = htmlspecialchars($_SESSION['user']);
                        echo "<a href='#' class='dropdown-toggle' data-toggle='dropdown'>" . ucfirst($username) . " <b class='caret'></b></a>";
...
<!--  J'ai  échappé les données dynamiques pour éviter les attaques XSS et j'ai utilisé les chemins absolus pour les liens d'icône. -->
<!-- a noté l'utilisation de htmlspecialchars() pour eviter les caracteres speciaux -->
